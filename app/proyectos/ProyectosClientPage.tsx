...
export default function ProyectosClientPage() {
  ...
  thumbnail: "/video-proyect/Proyecto2_thumb.jpg",
    ...
    {
      id: 2,
      title: "Vanitory Flotante de Contraste Elegante",
      city: "WINDOOR - Baños a Medida",
      category: "Vestidores, baños e interior",
      videoType: "mp4",
      videoUrl: "/video-proyect/vanitory-flotante-negro-madera-bacha-integrada.mp4",
      thumbnail: "/images/DSC09738.JPG",
      description: "Mueble de baño suspendido con acabados en madera oscura, bacha integrada y grifería negra mate, logrando un diseño moderno y sofisticado.",
    },
    {
      id: 3,
      title: "Vestidor Personalizado: Optimización y Textura",
      city: "WINDOOR - Vestidores y Organización",
      category: "Vestidores, baños e interior",
      videoType: "mp4",
      videoUrl: "/video-proyect/vestidor-abierto-personalizado-cajoneras-madera.mp4",
      thumbnail: "/images/DSC09740.JPG",
      description: "Interior de clóset modular diseñado a medida, combinando la textura símil madera con cajones en tono liso para maximizar la organización y el uso del espacio.",
    },
    {
      id: 4,
      title: "Frentes de Cajones con Sistema de Apertura Gola",
      city: "WINDOOR - Diseño Interior",
      category: "Vestidores, baños e interior",
      videoType: "mp4",
      videoUrl: "/video-proyect/gabinetes-sin-tiradores-sobres-cuarzo-veteado.mp4",
      thumbnail: "/images/DSC09680.JPG",
      description: "Enfoque en los cajones de la isla central, que cuentan con un moderno sistema de apertura \"gola\" (sin tirador), manteniendo una estética minimalista y limpia.",
    },
    {
      id: 5,
  ...
  const filters = ["Todas", "PVC", "Vestidores, baños e interior", "Puertas"];
