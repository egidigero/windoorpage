...
export default function WindoorHomepage() {
  ...
  // Reservation state now lives inside ReservationModal component
  ...
  // Reservation logic moved to ReservationModal component
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-6 left-6 z-50">
        <ReservationFloatingButton onClick={() => setShowReservationModal(true)} />
      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 font-light">Lunes a Sábado 10 a 19 hs</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4 group">
                    <div className="w-12 h-12 bg-[#E6D5C3] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
