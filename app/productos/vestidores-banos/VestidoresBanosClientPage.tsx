...
export default function VestidoresBanosClientPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 rounded-3xl p-8 lg:p-12">
              <LeadForm productTypeDefault="vestidores-banos" submitLabel="Enviar Consulta" />
            </div>
          </div>
        </div>
      </section>
      ...
      <ReservationModal open={showReservationModal} onClose={() => setShowReservationModal(false)} productTypePreset="vestidores-banos" />
