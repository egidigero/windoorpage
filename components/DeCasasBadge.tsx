...
interface DeCasasBadgeProps {
  show: boolean
  onClose: () => void
}

export default function DeCasasBadge({ show, onClose }: DeCasasBadgeProps) {
            ...
            <div className="p-6">
              <div className="flex items-start space-x-4">
                <Image
                  ...
                  width={220}
                  height={44}
                  className="h-11 w-auto flex-shrink-0 brightness-0 invert mt-1"
                />
